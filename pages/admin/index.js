      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              Kullanıcı değerlendirmelerini görüntüleyin ve analiz edin. Platform performansını ve kullanıcı memnuniyetini takip edin.
            </p>
            <Link href="/admin/ratings" className="inline-block w-full py-2 px-4 bg-yellow-600 text-white rounded-md text-center hover:bg-yellow-700 transition-colors">
