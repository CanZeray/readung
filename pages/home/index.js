  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 text-white py-3 md:py-5 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-xl mx-auto text-center">
              ...
              <p className="text-base md:text-lg text-blue-100 font-light mb-3">
                Improve your German skills by reading level-appropriate stories
              </p>
              {/* Translation Language Info */}
              <div className="flex items-center justify-center gap-2 bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2 inline-flex">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-yellow-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" />
                </svg>
                <span className="text-sm md:text-base font-medium text-white">
                  Translations available in <span className="text-yellow-300 font-bold">English</span> and <span className="text-yellow-300 font-bold">Türkçe</span>
                </span>
              </div>
            </div>
          </div>
        ...
        <section className="container mx-auto px-4 pt-6 pb-12 md:pt-8 md:pb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            <Link href="/stories/A1" className="group">
              <div className="relative h-full bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 rounded-2xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-2 border-emerald-100 hover:border-emerald-300 overflow-hidden flex flex-col">
                ...
                <div className="relative z-10 flex-grow">
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-16 h-16 bg-gradient-to-br from-emerald-400 to-green-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <span className="text-white font-bold text-xl">A1</span>
                    </div>
                    <svg className="w-6 h-6 text-emerald-600 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-2 group-hover:text-emerald-700 transition-colors">Beginner</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Perfect for complete beginners</p>
                </div>
            ...
            <Link href="/stories/A2" className="group">
              <div className="relative h-full bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50 rounded-2xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-2 border-teal-100 hover:border-teal-300 overflow-hidden flex flex-col">
                ...
                <div className="relative z-10 flex-grow">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <svg className="w-6 h-6 text-teal-600 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-2 group-hover:text-teal-700 transition-colors">Elementary</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Basic German knowledge required</p>
                </div>
            ...
            >
              <div className="relative h-full bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 rounded-2xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-2 border-amber-100 hover:border-amber-300 overflow-hidden flex flex-col">
                ...
                <div className="relative z-10 flex-grow">
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-16 h-16 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <span className="text-white font-bold text-xl">B1</span>
                    </div>
                    <svg className="w-6 h-6 text-amber-600 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-2 group-hover:text-amber-700 transition-colors">Intermediate</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Independent language use</p>
                </div>
            ...
            <div 
              ...
              className="group cursor-pointer"
            >
              <div className="relative h-full bg-gradient-to-br from-rose-50 via-pink-50 to-fuchsia-50 rounded-2xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-2 border-rose-100 hover:border-rose-300 overflow-hidden flex flex-col">
                ...
                <div className="relative z-10 flex-grow">
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-16 h-16 bg-gradient-to-br from-rose-400 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <span className="text-white font-bold text-xl">B2</span>
                    </div>
                    <svg className="w-6 h-6 text-rose-600 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </div>
                  <h3 className="text-2xl font-bold text-gray-800 mb-2 group-hover:text-rose-700 transition-colors">Upper Intermediate</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Complex topics and ideas</p>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            ...
            <div className="text-center mb-6">
              ...
              <div className="flex items-center justify-center gap-4 mb-4">
                <p className="text-gray-600">View the words you've learned here</p>
            ...
            <div className="relative group">
              <div className="bg-white rounded-2xl p-8 transition-all duration-300 shadow-lg hover:shadow-2xl border border-gray-100">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold text-gray-800 flex items-center">
                  <span className="w-2 h-2 bg-blue-500 rounded-full mr-2"></span>
                  Your Vocabulary
                </h3>
                <Link href="/vocabulary" className="text-blue-600 hover:text-blue-700 text-sm font-semibold transition-colors flex items-center group">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 mb-6 border border-blue-100">
                <p className="text-sm text-gray-700">
                  Daily limit: <span className="font-bold text-blue-600">{userData?.membershipType === 'premium' ? 'Unlimited' : '3'} words remaining</span>
                </p>
              </div>
              ...
              {savedWords.length > 0 ? (
                <div className="space-y-2">
                  {savedWords.map((wordObj, index) => {
                    ...
                    return (
                      <div key={safeKey} className="flex justify-between items-center py-3 px-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl hover:from-blue-50 hover:to-purple-50 transition-all duration-300 border border-gray-100 hover:border-blue-200 group">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-700 mb-2 font-semibold text-lg">No saved words yet</p>
                  <p className="text-sm text-gray-500">Read stories and save words to build your vocabulary</p>
                </div>
              )}
              </div>
            </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              {/* Membership Card */}
              <div 
                className={`relative group rounded-xl p-6 transition-all duration-300 shadow-md hover:shadow-xl border
                  ${userData?.membershipType === 'premium' 
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-2 border-t border-gray-300">
                    ...
                    <div className="text-center">
                      <h3 className="text-lg font-bold text-blue-800 mb-3">Free</h3>
                      <ul className="space-y-2 text-left">
                        <li className="flex items-start gap-2">
                          ...
                          <span className="text-xs text-gray-700">Limited A1 & A2</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <svg className="h-4 w-4 text-blue-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                          <span className="text-xs text-gray-700">Save 3 words/day</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    {/* Premium Column */}
                    <div className="text-center">
                      <h3 className="text-lg font-bold text-yellow-800 mb-3">Premium</h3>
                      <ul className="space-y-2 text-left">
                        <li className="flex items-start gap-2">
                          <svg className="h-4 w-4 text-yellow-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                          <span className="text-xs text-gray-700">All levels (A1-B2)</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <svg className="h-4 w-4 text-yellow-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                          <span className="text-xs text-gray-700">Unlimited words</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  {(['free', 'basic'].includes(userData?.membershipType) || !userData?.membershipType) && (
                    <div className="pt-3">
                      <Link href="/upgrade/premium">
                        <button className="w-full py-4 px-5 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white font-extrabold text-lg text-center rounded-xl shadow-2xl hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] transform hover:scale-105 transition-all duration-300 border-[3px] border-yellow-300 hover:border-yellow-200 cursor-pointer ring-4 ring-yellow-200/60 hover:ring-yellow-300/80 relative overflow-hidden"
