  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button
        ...
        className="mt-4 w-full py-3 bg-primary-600 text-white rounded-md hover:bg-primary-700 disabled:opacity-50"
      >
...
export default function Upgrade() {
  ...
  const getPlanPrice = () => {
    return selectedPlan === 'monthly' ? '€4.99/month' : '€50/year (€4.17/month)';
  };
  ...
  const getPlanDetails = () => {
    if (selectedPlan === 'monthly') {
      ...
      return {
        ...
        price: '€50',
        period: 'year',
        billingText: 'billed annually (€4.17/month)'
      };
    }
  };
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
              ...
              >
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold mb-1">€4.99<span className="text-sm text-gray-500">/month</span></div>
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold mb-1">€59.88<span className="text-sm text-gray-500">/year</span></div>
                  <p className="text-gray-600 text-sm">Only €4.99/month, billed annually</p>
                  <p className="text-secondary font-medium text-sm mb-3">Save €54 per year</p>
          ...
          <div>
            ...
            {/* Premium Membership kutusu */}
            <div className="card mt-6 mb-4 p-4 bg-white rounded-lg shadow">
              <h2 className="font-bold text-lg mb-2">Premium Membership</h2>
              <div className="flex items-end">
                <span className="text-3xl font-bold text-gray-900 mr-2">€9.9</span>
                <span className="text-base text-gray-500">/month</span>
              </div>
              <p className="text-gray-600 text-sm mt-1">Monthly plan, unlimited access</p>
            </div>
          </div>
        </div>
      </main>
