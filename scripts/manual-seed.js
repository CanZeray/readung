...
// Admin SDK ile Firebase'i başlat
const serviceAccount = {
  type: "service_account",
  project_id: process.env.FIREBASE_PROJECT_ID,
  private_key_id: "e87846d9989567bbd56d69bae4cea6fc3971d474", // JSON dosyasından kopyalayın
  private_key: process.env.FIREBASE_PRIVATE_KEY.replace(/\\n/g, '\n'),
  client_email: process.env.FIREBASE_CLIENT_EMAIL,
  client_id: "111645060876870765533", // JSON dosyasından kopyalayın
  auth_uri: "https://accounts.google.com/o/oauth2/auth",
  token_uri: "https://oauth2.googleapis.com/token",
  auth_provider_x509_cert_url: "https://www.googleapis.com/oauth2/v1/certs",
  client_x509_cert_url: "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40readung-606c9.iam.gserviceaccount.com",
  universe_domain: "googleapis.com"
};

// Zaten başlatılmadıysa başlat
